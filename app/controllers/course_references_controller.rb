class CourseReferencesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @course_reference.save
        format.html { redirect_to @course_reference, notice: 'Course reference was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @course_reference.update_attributes(params[:course_reference])
        format.html { redirect_to @course_reference, notice: 'Course reference was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to course_references_url }
      format.json { head :no_content }
    end
  end
end
