...
ActiveRecord::Schema.define(version: 20140114204358) do
  ...
  add_index "class_topics", ["classroom_id"], name: "index_class_topics_on_class_id", using: :btree
  ...
  add_index "references", ["term_reference_id"], name: "index_references_on_course_reference_id", using: :btree
  ...
  add_index "term_references", ["book_id"], name: "index_course_references_on_book_id", using: :btree
  add_index "term_references", ["term_id"], name: "index_course_references_on_course_id", using: :btree
